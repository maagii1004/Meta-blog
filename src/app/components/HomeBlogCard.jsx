...
export const HomeBlogCard = () => {
    return (
        <div className="w-full h-[476px] border border-[#E8E8EA] rounded-lg overflow-hidden hover:cursor-pointer transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 ...">
