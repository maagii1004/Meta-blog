...
export const AllBlogCard = () => {
    return (
        <div className="w-full h-[488px] border border-[#E8E8EA] rounded-lg overflow-hidden hover:cursor-pointer transition ease-in-out delay-10 hover:-translate-y-1 hover:scale-110 duration-300 ...">
            ...
            <div className="p-4">
                ...
                <div className="flex items-center gap-3 ml-3.5 mt-5">
                    <img src="./pfp.png" alt="" className="w-9 h-9"/>
                    <p>Eric Smith</p>
                    <p className="text-[#97989F] ml-3">August 20, 2022</p>
                </div>
